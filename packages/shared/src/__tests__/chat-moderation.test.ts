import { ProfanityFilter, ProfanityConfig } from '../chat-moderation'

describe('ProfanityFilter', () => {
  // Test configuration with sample profanity words
  const testConfig: ProfanityConfig = {
    HIGH: ['fuck', 'fucking', 'fucker'],
    MEDIUM: ['shit', 'damn', 'bitch', 'ass'],
    LOW: ['hell', 'sucks', 'crap']
  }

  function createTestFilter(): ProfanityFilter {
    return new ProfanityFilter(testConfig)
  }
